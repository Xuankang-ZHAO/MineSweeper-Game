...
public class ImageResource {
    ...
    public static ImageIcon p5 = new ImageIcon("resouces/pictures/冰面.PNG");
    public static ImageIcon p5Plus = change(p5, 0.2);
    public static ImageIcon p6 = new ImageIcon("resouces/pictures/苦力怕贴图.PNG");
    ...
    public static ImageIcon p8 = new ImageIcon("resouces/pictures/贴图史蒂夫.png");
    public static ImageIcon p8Plus = change(p8, 0.08);
    public static ImageIcon p9 = new ImageIcon("resouces/pictures/沙面.PNG");
    public static ImageIcon p9Plus = change(p9, 0.12);
    public static ImageIcon p10 = new ImageIcon("resouces/pictures/苦力怕贴图.PNG");
